...
#Edit script for hisat2
nano PacuHISAT2.sh #This opens another window where one pastes this script

#Nota: There's a mistake with this script from hisat2 down
...
#This line of code downloads, decompresses and deletes the compressed file for the GFF file for Pocillopora acuta
curl -o Pocillopora_acuta_HIv2.genes.gff3.gz http://cyanophora.rutgers.edu/Pocillopora_acuta/Pocillopora_acuta_HIv2.genes.gff3.gz && gunzip Pocillopora_acuta_HIv2.genes.gff3.gz
ln -s /data/putnamlab/Amalia_Murgueitio/P_acuta/Mapping_P_acuta/Pocillopora_acuta_HIv2.assembly.fasta /data/putnamlab/Amalia_Murgueitio/P_acuta/Mapping_P_acuta/data/stringtie
cd /data/putnamlab/Amalia_Murgueitio/P_acuta/Mapping_P_acuta/data/stringtie
mkdir BAM
ln -s /data/putnamlab/Amalia_Murgueitio/P_acuta/Mapping_P_acuta/data/hisat2/18_bam_files/Bam_files/*.bam /data/putnamlab/Amalia_Murgueitio/P_acuta/Mapping_P_acuta/data/stringtie/BAM
...
array1=($(ls ${F}/BAM/*_cleaned_R1.bam))

for i in "${array1[@]}"; do
        stringtie -A gene_abund/$(basename ${i}).gene_abund.tab -p $SLURM_NTASKS_PER_NODE --rf -e -G Pocillopora_acuta_HIv2.genes.gff3 -o ${i}.gtf ${i}
...
stringtie --merge -p 8 -G /data/putnamlab/Amalia_Murgueitio/P_acuta/Mapping_P_acuta/data/stringtie/Pocillopora_acuta_HIv2.genes.gff3 -o /data/putnamlab/Amalia_Murgueitio/P_acuta/Mapping_P_acuta/data/stringtie/stringtie_merged.gtf /data/putnamlab/Amalia_Murgueitio/P_acuta/Mapping_P_acuta/data/stringtie/stringtie_mergelist_Pacu.txt 
