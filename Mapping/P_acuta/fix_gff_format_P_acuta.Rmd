...
author: "Ariana S Huffmyer, modified Amalia Murgueitio"
date: "2024"
...
```{r}
gff <- read.csv(file="E:/Users/amurgueitio/Documents/Multistage_omics/R scripts/P. acuta/New_genome_P_acuta/fixed_gff/Pocillopora_acuta_HIv2.genes.gff3", header=FALSE, sep="\t")
...
```{r}
write.table(gff, file="E:/Users/amurgueitio/Documents/Multistage_omics/R scripts/P. acuta/New_genome_P_acuta/fixed_gff/Pocillopora_acuta_HIv2.genes_fixed.gff3", sep="\t", col.names = FALSE, row.names=FALSE, quote=FALSE)

#gzip the file 
gzip("E:/Users/amurgueitio/Documents/Multistage_omics/R scripts/P. acuta/New_genome_P_acuta/fixed_gff/Pocillopora_acuta_HIv2.genes_fixed.gff3")
```
