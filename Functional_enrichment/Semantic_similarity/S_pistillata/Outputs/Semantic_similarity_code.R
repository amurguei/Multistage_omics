...
Cluster8SpisGOdissBP = GO_similarity(Cluster8SpisGOBP, ont = "BP", db = "org.Hs.eg.db")
pdf(file = "semantic_similarity/Cluster8SpisGOBP_GOSEM_less_words.pdf", width = 10, height = 7)
simplifyGO(Cluster8SpisGOdissBP, word_cloud_grob_param = list(max_width = 60), max_words=17)
dev.off()
...
larvaeSpisGO_BP <- larvaeSpisGO %>% filter(ontology == "BP")
larvaeSpisGOBP <- larvaeSpisGO_BP$category
...
#Calculate a similarity matrix and save the output.
larvaeSpisGOdissBP = GO_similarity(larvaeSpisGOBP, ont = "BP", db = "org.Hs.eg.db")
...
#Calculate a similarity matrix and save the output.
metaSpisGOdissBP = GO_similarity(metaSpisGOBP, ont = "BP", db = "org.Hs.eg.db")
pdf(file = "semantic_similarity/metaSpisGOBP_evenlesscrowded_GOSEM.pdf", width = 10, height = 7)
simplifyGO(metaSpisGOdissBP, word_cloud_grob_param = list(max_width = 60), max_words=12)
dev.off()
...
pdf(file = "semantic_similarity/metaSpisGOCCO_GOSEM_Increasedwidth.pdf", width = 10, height = 7)
